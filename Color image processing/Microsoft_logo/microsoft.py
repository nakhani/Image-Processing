...
def create_logo():
    ...
    logo_image = cv2.merge([blue_channel, green_channel, red_channel])
    
    
    cv2.putText(logo_image, 'Microsoft', (340, 255), cv2.FONT_HERSHEY_TRIPLEX  , 3.7, (255, 255, 255), 5, cv2.LINE_AA)
