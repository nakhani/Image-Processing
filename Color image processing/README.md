...
### 1. Converting a color image to a grayscale image
  ...
  #### Input:
   ...
   <img src="color_to_gray/image-classification-input.jpeg" width="300">

  #### Output:

   <img src="color_to_gray/grayscale_image.png" width="300">
...
### 3. Materwelon
  ...
  Converting Watermelon 🍉 to Materwelon. 

   #### Input:
  
   <img src="Watermelon/image.png" width="300">

  #### Output:

   <img src="Watermelon/materwelon.jpg" width="300">
...
### 4. Rubik's cube
  ...
  #### Input:
   ...
   <img src="rubik_cube/image (1).png" width="300">

  #### Output:

   <img src="rubik_cube/result.png" width="300">
...
### 5.  Microsoft logo
  ...
  #### Output:
   ...
   <img src="Microsoft_logo/result.png" width="300">
